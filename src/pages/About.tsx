...
import { Target, Heart, Users, Award, BookOpen, TrendingUp, Globe, Shield, Lightbulb, Zap, Star, MapPin, Languages, Briefcase } from "lucide-react";
const About = () => {
  const values = [{
  ...
  return <div className="bg-background">
      ...
      <section className="section-padding bg-gradient-to-br from-primary/10 via-primary/5 to-background">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <Badge className="mb-6">À propos de Formacad</Badge>
      ...
      <section className="section-padding bg-secondary/30">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {values.map((value, index) => <Card key={index} className="p-8 hover:shadow-lg transition-all duration-300">
      ...
      <section className="section-padding bg-secondary/30">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {teamMembers.map((member, index) => <Card key={index} className="p-6">
                <div className="mb-4">
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <div className="max-w-3xl mx-auto">
            {milestones.map((milestone, index) => <div key={index} className="flex items-start space-x-6 pb-8 relative">
                {index !== milestones.length - 1 && <div className="absolute left-6 top-12 w-0.5 h-full bg-border" />}
