  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        <AppSidebar user={user} onLoginClick={openModal} />
      </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center flex-shrink-0">
                ...
                <SidebarTrigger className="lg:hidden mr-3 p-2" />
              ...
              {/* Center - Explore Menu & Search (Desktop Only) */}
              <div className="hidden lg:flex items-center gap-3 md:gap-6 flex-1 max-w-2xl mx-4 md:mx-6">
