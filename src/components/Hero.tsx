...
const carouselItems = [{
  layout: () => <div className="relative w-full mb-10 items-start overflow-hidden bg-background">
        ...
        <div className="absolute -inset-y-0 w-[45%] right-0 top-0">
          <img src="/lovable-uploads/1f6a2417-0f18-43a3-b0f3-6a65ecad2be2.png" alt="Learning Community" className="w-full h-full object-cover object-right" />
        </div>
  ...
  layout: () => <div className="relative w-full">
        ...
        <div className="absolute -inset-y-4 w-[50%] right-0">
          <img src="/lovable-uploads/1f6a2417-0f18-43a3-b0f3-6a65ecad2be2.png" alt="Student Learning" className="w-full h-full object-cover object-right" />
        </div>
  ...
  layout: () => <div className="relative w-full flex flex-row-reverse items-center overflow-hidden">
        ...
        {/* Background Image */}
        <div className="absolute w-[70%] max-w-none left-[-15%] top-1/2 -translate-y-1/2 overflow-hidden">
          <img src="/lovable-uploads/1f6a2417-0f18-43a3-b0f3-6a65ecad2be2.png" alt="Learning Success" className="object-cover object-right scale-75 w-[900px] h-[600px]" />
        </div>
      </div>
}, {
  layout: () => <div className="relative w-full">
        ...
        <div className="absolute -inset-y-3 w-[55%] right-0">
          <img src="/lovable-uploads/1f6a2417-0f18-43a3-b0f3-6a65ecad2be2.png" alt="Expert Instruction" className="w-full h-full object-cover object-right" />
        </div>
