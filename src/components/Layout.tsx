  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-[9999] overflow-hidden">
        ...
        <div className="fixed top-80 left-25 w-56 h-56 bg-gradient-to-br from-primary/18 to-primary/28 rounded-full blur-3xl animate-float opacity-65" style={{animationDelay: '4s', animationDuration: '10s'}} />
      </div>
