  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-[9999] overflow-hidden">
        ...
        {/* Secondary Blob */}
        <div className="absolute top-1/5  w-80 h-80 bg-gradient-to-br from-primary/20 to-primary/30 rounded-full blur-3xl animate-float" style={{animationDelay: '2s', animationDirection: 'reverse'}} />
